...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goToAddPostButton: Button = findViewById(R.id.home_addPost_button)
        val goToPostsButton: Button = findViewById(R.id.home_posts_button)
        val db = Firebase.firestore

        goToAddPostButton.setOnClickListener {
            val addPostIntent = Intent(this, AddPostActivity::class.java)
            startActivity(addPostIntent)
        }
        goToPostsButton.setOnClickListener {
